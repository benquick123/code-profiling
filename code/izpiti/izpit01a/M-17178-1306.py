def migracije(ime_datoteke):
    ...
    for vrstica in open(ime_datoteke):
        ...
        stevilo_pop = stevilo.strip(":")

        vsota = stevilo_pop

        mesto = vrstica.split("->")[0]
        mesto_pop = mesto.split()[1]
        prvo = mesto_pop

        mesto2 = vrstica.split("->")[1]
        mesto2_pop = mesto2.strip()
...
def zakladi(navodila):
    ...
    if navodila == "":
        ...
        for e in navodila:
            ...
            vsota = robot.koordinate()[0] + robot.koordinate()[1]
            if vsota % 7 == 0:
                st += 1
        return st
