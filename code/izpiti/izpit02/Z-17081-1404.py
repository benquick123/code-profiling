...
def nogavice(s):
    ...
    for stevilka in s:
        ...
        if slovar[stevilka] % 2 == 1 and stevilka not in brez:

            brez.append(stevilka)
...
def bingo(listki, vrstni_red):
    ...
    precrtani = [0] * len(listki)

    for stevilka in vrstni_red:

        for i in range(0, len(listki)):
...
class Sledilnik:
    ...
    def prebivalci(self, kraj):
        ...
        for kraj2, oseba2 in self.kraji:

            if kraj2 == kraj:

                prebivalci.append(oseba2)

        return set(prebivalci)
    ...
    def preseli(self, oseba, kraj):
        ...
        for kraj2, oseba2 in self.kraji:
            ...
            if oseba2 == oseba:
                ...
                self.kraji[self.kraji.index((kraj2, oseba2))] = (kraj, oseba)
    ...
    def preseli_vse(self, odkod, kam):
        ...
        for kraj2, oseba2 in self.kraji:
            ...
            if kraj2 == odkod:
                ...
                self.kraji[self.kraji.index((kraj2, oseba2))]= (kam, oseba2)
