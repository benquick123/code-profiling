class Carovnik:
    def __init__(self, znanje, vsota):
        self.iz = znanje.split()[0]
        self.v = znanje.split()[2]
        self.denar = vsota
        self.caranje = 0
    def caraj(self, s):
        t = []
    ...
    def zasluzek(self):
        return self.caranje * self.denar
