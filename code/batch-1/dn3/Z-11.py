...
for city, x, y in kraji:
 razdalja = sqrt(pow(x - city_x, 2) + pow(y - city_y, 2))
 if razdalja < domet and(max is None or max < razdalja):
          max = razdalja
          max_city = city

print("{} je na koordinatah {} {}".format(kraj, city_x, city_y))
print("Iz kraja {} lahko zalijemo kraj {} na razdalji {}".format(kraj, max_city, max))
