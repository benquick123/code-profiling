...
for ime, koordinata_x, koordinata_y in kraji:
    if kraj == ime:
        print(kraj, 'je na koordinatah', koordinata_x, koordinata_y)
        x = koordinata_x
        y = koordinata_y
for ime2, koordinata_x2, koordinata_y2 in kraji:
    nov_kraj = sqrt((koordinata_x2 - x) ** 2 + (koordinata_y2 - y) ** 2)
    if nov_kraj < domet and kraj != ime2 and nov_kraj > kraj2:
        kraj_final = ime2
        kraj2 = nov_kraj
print('Iz kraja', kraj, 'lahko zalijemo kraj', kraj_final, 'na razdalji', kraj2, '.')