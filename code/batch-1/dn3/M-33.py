kraji = [
    ...
    ('Radenci', 100.61, 84.00), ('Èrna', 15.41, 66.57),
    ('Radeèe', 39.05, 24.57),
    ...
    ('Ormož', 107.71, 61.32),
    ('Škofije', -59.14, -27.93), ('Èepovan', -60.35, 22.78),
    ...
    ('Koèevje', 16.61, -21.00), ('Soèa', -69.79, 52.50),
    ('Ajdovšèina', -53.25, 5.25),
    ('Bohinjska Bistrica', -48.49, 47.25), ('Tržiè', -22.44, 56.07),
    ('Piran', -75.69, -31.50),
