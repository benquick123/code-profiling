...
izbrani_kraj = input("Izberi kraj: ")
domet = float(input("Izberi domet vodnega topa: "))

najbolj_oddaljen_kraj = "ki ne obstaja";
najvecja_razdalja = 0;
izbrana_koordinata1 = 0;
izbrana_koordinata2 = 0;

for kraj, koordinata1, koordinata2 in kraji:
    if izbrani_kraj==kraj:
        izbrana_koordinata1 = koordinata1;
        izbrana_koordinata2 = koordinata2;
        print(str(kraj) + ' je na koordinatah ' + str(koordinata1) + ', ' + str(koordinata2))
...
print('Iz kraja ' +  str(izbrani_kraj) + ' lahko zalijemo kraj ' + str(najbolj_oddaljen_kraj) + ' na razdalji ' +  str(najvecja_razdalja))

#DODATNA NALOGA:
print("Zdaj pa še dodatna naloga!")

izbrani_kraj1 = input("Izberi prvi kraj: ")
izbrani_kraj2 = input("Izberi drugi kraj: ")
domet2 = float(input("Izberi domet vodnega topa obeh krajev: "))

izbrana_koordinata1_kraja1 = 0;
izbrana_koordinata2_kraja1 = 0;
izbrana_koordinata1_kraja2 = 0;
izbrana_koordinata2_kraja2 = 0;

kraji_ki_jih_dosezeta_oba_kraja = []

for kraj, koordinata1, koordinata2 in kraji:
    if izbrani_kraj1==kraj:
        izbrana_koordinata1_kraja1 = koordinata1;
        izbrana_koordinata2_kraja1 = koordinata2;

    if izbrani_kraj2==kraj:
        izbrana_koordinata1_kraja2 = koordinata1;
        izbrana_koordinata2_kraja2 = koordinata2;

for kraj, koordinata1, koordinata2 in kraji:
        razdalja1 = sqrt((izbrana_koordinata1_kraja1 - koordinata1)**2 + (izbrana_koordinata2_kraja1 - koordinata2)**2)
        razdalja2 = sqrt((izbrana_koordinata1_kraja2 - koordinata1) ** 2 + (izbrana_koordinata2_kraja2 - koordinata2) ** 2)

        if razdalja1 <= domet2 and razdalja2 <= domet2:
            kraji_ki_jih_dosezeta_oba_kraja.append(str(kraj));

print("Kraji, ki jih lahko dosežeta oba izbrana kraja: ")
print(str(kraji_ki_jih_dosezeta_oba_kraja))