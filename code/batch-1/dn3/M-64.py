    ...
    if ime == kraj:
        ...
        for ime1, x1, y1 in kraji:
            ...
            if max_razdalja < razdalja <= domet:
                ...
                max_kraj = ime1
print("Iz kraja", ime, "lahko zalijemo kraj", max_kraj, "na razdalji", max_razdalja, "\n")
...
for ime1, x1, y1 in kraji:
    if ime1 == kraj1:
        for ime2, x2, y2 in kraji:
            if ime2 == kraj2:
                for temp_ime, temp_x, temp_y in kraji:
                    razdalja1 = sqrt((x1 - temp_x)**2 + (y1 - temp_y)**2)
                    razdalja2 = sqrt((x2 - temp_x) ** 2 + (y2 - temp_y) ** 2)
