...
def v_dometu(ime , domet , kraji):
    ...
    for kraj , x2, y2 in kraji:
        if razdalja_koordinat(x1,y1,x2,y2) <= domet and kraj != ime:
            s.append(kraj)
    return s
...
def najbolj_oddaljeni(ime, imena , kraji):
    ...
    for ime in imena:
        ...
        if dalec < razdalja_koordinat(x1, y1, x2, y2):
            dalec = razdalja_koordinat(x1 , y1, x2, y2)
            ime_dalec = ime
    return ime_dalec
...
def zalijemo(ime, domet, kraji):
    ...
    x1 , y1 =  koordinate(ime , kraji)
    for kraj , x2, y2 in kraji:
        if dalec < razdalja_koordinat(x1,y1,x2,y2) <= domet and kraj != ime:
            dalec = razdalja_koordinat(x1,y1,x2,y2)
            ime_dalec = kraj
