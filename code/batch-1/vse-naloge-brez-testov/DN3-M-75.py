...
print(kraj,'je na koordinatah',koord_x,koord_y)

najv_razdalja=0

for ime, x, y in kraji:
	razdalja = sqrt((koord_y - y)**2 + (koord_x - x)**2)
	if razdalja > najv_razdalja and razdalja < domet:
		iskan_kraj = ime
		najv_razdalja = razdalja
	
print('Iz kraja',kraj,'lahko zalijemo kraj',iskan_kraj,'na razdalji',najv_razdalja)