...
for place in kraji:
    ...
    if kraj == str(name):
        ...
        c = float(y)
        break
print(a, "is in coordinats", b, "and", c, "and has a range of", range)
e =0
for place2 in kraji:
    ime2, x2, y2 = place2
    d = sqrt((x2-b)**2 + (y2-c)**2)
    if d<= range and d>=e:
        e = d
        z = e
        a2 = ime2
        b2 = x2
        c2 = y2
print("From the place", a, "we can wather place", a2, "which is at a distance of", z)
