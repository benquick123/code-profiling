...
#         naj_kraj = mesto
#
# print(kraj + " je na koordinatah " + str(x_m) + " " + str(y_m))
# print("Iz " + kraj + " lahko zalijemo kraj " + naj_kraj + " na razdalji " + str(naj_r))
...
for mestob, x, y in kraji:
    if mestob == kraj2:
       x_b = x
       y_b = y

for mesto, x, y in kraji:
    r1 = sqrt((x-x_l) ** 2 + (y-y_l) ** 2)
    r2 = sqrt((x-x_b) ** 2 + (y-y_b) ** 2)
