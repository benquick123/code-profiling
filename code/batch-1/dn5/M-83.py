...
class TestTviti(unittest.TestCase):
    tviti = [
        "sandra: Spet ta deÅ¾. #dougcajt",
        "berta: @sandra Delaj domaÄo za #programiranje1",
        "sandra: @berta Ne maram #programiranje1 #krneki",
        "ana: kdo so te @berta, @cilka, @dani? #krneki",
        "cilka: jst sm pa #luft",
        "benjamin: pogreÅ¡am ano #zalosten",
        "ema: @benjamin @ana #split? po dvopiÄju, za zaÄetek?",
    ]
    ...
    def test_avtor(self):
        self.assertEqual(avtor("janez: pred dvopiÄjem avtor, potem besedilo"), "janez")
