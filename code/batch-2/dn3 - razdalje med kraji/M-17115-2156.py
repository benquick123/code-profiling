#Tretja domača naloga pri Programiranje 1.
kraji = [
...
#domet=float(input("Vnesi domet topa: "))
naj_raz=0
naj_kraj=""
...
for ime,x,y in kraji:
    ...
    if razdalja>naj_raz and razdalja<=domet:
        naj_raz=razdalja
        naj_kraj=ime
print("Iz kraja ",kraj," lahko zalijemo kraj",naj_kraj," na razdalji ",naj_raz)
'''
...
kraj2 = "Bled"
domet = 30
#kraj1=input("Vnesi prvi kraj : ")
#kraj2=input("Vnesi drugi kraj : ")
#domet=float(input("Vnesi domet topa: "))
for ime,x,y in kraji:
    if kraj1 == ime:
        x1=x
...
for ime,x,y in kraji:
    if x1!=x and y1!=y and x2!=x and y2!=y: #zato da ne zalijeta eden drugega
