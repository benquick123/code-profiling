...
for x in kraji:
    x2 = x[1]
    y2 = x[2]
    razdalja = izracun(x1,y1,x2,y2)
    if razdalja < domet:
        if razdalja > a:
            kraj_z = x[0]
            a = razdalja
print(kraj,"je na koordinatah",x1,y1)
print("Iz kraja",kraj,"lahko zalijemo kraj",kraj_z,"na razdalji",a)
...
for x in kraji:
    x2 = x[1]
    y2 = x[2]
    razdalja_1 = izracun(kraj1_x1,kraj1_y1,x2,y2)
    razdalja_2 = izracun(kraj2_x1,kraj2_y1,x2,y2)
