...
najrazdalja = 0
najkraj = 0
for mesta, dolzina, sirina in kraji:
    if mesta == mesto:
        dolzina1 = dolzina
        sirina1 = sirina
        print(mesto, "je na koordinatah", dolzina1, sirina1)
for kraj, dolzina, sirina in kraji:
    x = (sirina1 - sirina) ** 2
    y = (dolzina1- dolzina) ** 2
    razdalja = sqrt(x+y)
    if domet >= razdalja >= najrazdalja:
        najrazdalja = razdalja
        najkraj = kraj
print("Iz kraja", mesto, "lahko zalijemo kraj", najkraj, "na razdalji", najrazdalja)
...
for kraj, dolzina, sirina in kraji:
    ...
    if razdalja < domet:
        x1 = (sirina2 - sirina) ** 2
        y1 = (dolzina2 - dolzina) ** 2
        razdalja1 = sqrt(x1 + y1)
        if razdalja1 < domet:
            print(kraj)
