...
#obvezna naloga
print("_______________________ Obvezna Naloga _______________________")
ime_kraja = "Litija"
domet = 60
najvec = 0
...
print(ime_kraja,"je na koordinatah",x1,y1)
print("Iz kraja",ime_kraja,"lahko zalijemo kraj",a,"na razdalji",najvec)
print("")
...
#dodatna naloga
print("________________________ Bonus Naloga ________________________")
ime_kraja = "Ljubljana"
ime_kraja2 = "Bled"
domet = 30
for ime, x, y in kraji:
