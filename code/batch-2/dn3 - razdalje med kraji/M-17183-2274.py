...
for i in range(0, len(kraji)):
  ...
  distX = abs(currX-krajX)
  distY = abs(currY-krajY)
  
  dist = sqrt(distX**2 + distY**2)
  
  if(dist <= domet and currDomet < dist):
    currDomet = dist
    currKrajIdx = i
    
  
if(currKrajIdx > -1):
  print("Kraj", kraji[currKrajIdx][0], "je na kordinatah", kraji[currKrajIdx][1], kraji[currKrajIdx][2])
  print("Iz kraja", kraj, "lahko zalijemo kraj", kraji[currKrajIdx][0], "na razdalji", currDomet)
...
for i in range(0, len(kraji)):
  ...
  distX = abs(currX-krajX)
  distY = abs(currY-krajY)
  dist2X = abs(currX-Kraj2X)
  dist2Y = abs(currY-kraj2Y)
  
  dist = sqrt(distX**2 + distY**2)
  dist2 = sqrt(dist2X**2 + dist2Y**2)
  
  
  
  if(dist <= domet and dist2 <= domet):
    print(kraji[i][0])
