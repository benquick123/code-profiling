...
kraj =	input("Vnesite ime kraja z veliko začetnico: ")
domet = int(input("Vnesite domet vodnega topa: "))
...
for ime,x1,y1 in kraji:
	if ime == kraj:
		...
		for ime,x2,y2 in kraji:	
			...
			if razdalja < domet:
				if(razdalja > razdalja2):
					stevec = stevec + 1
					ime2 = ime
					if (stevec > max):
						max = stevec
						razdalja2 = razdalja
		print("Iz kraja",kraj, "lahko zalijemo kraj", ime2,"na razdalji", razdalja2)
