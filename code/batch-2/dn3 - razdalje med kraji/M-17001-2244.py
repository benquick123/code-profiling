...
question1 = input("Input kraj")
cannon = int(input("The range of a cannon is?"))
maxp = 0
maxk = None
for (ime, x, y) in kraji:
    if question1 in ime:
        for (ime2, x2, y2) in kraji:
            ...
            if cannon > a and a > maxp:
                maxp = a
                maxk = ime2
        print(question1, "je na koordinatah", x, y)
print("Iz kraja", question1, "lahko zalijemo kraj", maxk, "na razdalji", maxp)
