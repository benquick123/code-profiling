...
for ime, x, y in kraji:
    ...
    razdalja = math.sqrt((x - kraj_x)**2 + (y - kraj_y)**2)

    if max_razdalja < razdalja and razdalja< domet:
        max_razdalja = razdalja
        ime_kraja = ime

print(kraj, "je na koordinatah", kraj_x, kraj_y)
print("Iz kraja", kraj, "lahko zalijemo kraj", ime_kraja, "na razdalji", max_razdalja)
