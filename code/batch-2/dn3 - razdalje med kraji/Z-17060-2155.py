...
# skriti kraji s koordinatami

from math import *
#potrebne funkcije za računanje razdalje
kraj = "Ljubljana"
domet= 30
#najprej opišemo Ljubljano-uvedba nove spremenljivke
ljubljana_x = 0
ljubljana_y = 0
...
razdalja_a = 0
mesto = ""
#upoštevana vsa mesta
for ime_kraja, x, y in kraji:
    a = sqrt((ljubljana_x - x)**2 + ( ljubljana_y - y)**2)
    #pitagora ljubljana do drugega kraja-koordinate (x, y)
    if a < 30 and a > razdalja_a:
        #stično oklepaji in dvopičje!
        razdalja_a = a
        mesto = ime_kraja

print("Mesto", mesto, "je od Ljubljana oddaljeno", razdalja_a)
