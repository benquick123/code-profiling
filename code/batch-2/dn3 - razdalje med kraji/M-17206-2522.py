...
zacetek=0
ljubljana=kraj
print(izbrani_kraj, "je na lokaciji", x, y)
xx=x
yy=y
for kraj,x,y in kraji:
    dolzina=sqrt((x-xx)**2+(y-yy)**2)
    if dolzina<domet and dolzina>zacetek:
        lokacija=izbrani_kraj
        zacetek=dolzina
print("Iz", ljubljana, "zadanemo", lokacija, "z dolzine", zacetek)
