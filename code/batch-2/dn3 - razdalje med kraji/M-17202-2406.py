...
print("Iz kraja",kraj, "lahko zalijemo kraj", ime, "na razdalji", razdalja2)



# RAZMAK MED IZPISI OBEH NALOG
 print()
...
for i,x,y in kraji:
    tmp1=sqrt(((x - x1) ** 2) + ((y - y1) ** 2))
    tmp2=sqrt(((x - x2) ** 2) + ((y - y2) ** 2))
    if tmp1<=domet and tmp2<=domet:
        print(i)
