...
for mesto, x2, y2 in kraji:
    razdalja = sqrt(((x2-x1)*(x2-x1))+((y2-y1)*(y2-y1)))
    if razdalja < domet and razdalja > najvecja_mozna:
        najvecja_mozna = razdalja
        drugi_kraj = mesto

print(kraj, "je na koordinatah:",x1, y1)
print("Iz kraja",kraj, "lahko zadanemo kraj", drugi_kraj, "na razdalji:", najvecja_mozna)