'''
    PROGRAM: različne naloge z razdaljami med kraji
    AVTOR: Blaž Kumer
'''
...
najIme=""
for ime,x,y in kraji:
    z=sqrt((xIskanega-x)**2+(yIskanega-y)**2)
    if z<domet:
        if z>najRaz:
            najRaz=z
            najIme=ime
...
print("iz kraja", imeIskanega,"lahko zalijemo", najIme,"na razdalji",najRaz)
