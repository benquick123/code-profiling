...
min_razdalja=0
for ime,x,y in kraji:
    razdalja=sqrt((x-kraj_x)**2+(y-kraj_y)**2)
    if razdalja < domet and razdalja >min_razdalja:
        min_razdalja=razdalja
        iskan_kraj=ime
print(kraj,"je na koordinatah",kraj_x,"ter",kraj_y)
print("Iz kraja",kraj,"lahko zalijemo kraj",iskan_kraj,"na razdalji",min_razdalja)
