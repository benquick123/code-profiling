...
for Ime, xk, yk in kraji:
    ...
    yy = yk2 - yk1
    d = sqrt(xx**2 + yy**2)
    if najdaljsaRazdalja < d < domet:
        najdaljsaRazdalja = d
        imeNajdaljsegaKraja = Ime


print(kraj , 'je na koordinatah ' , xk1 , yk1)
print('Iz kraja ' , kraj , 'lahko zalijemo kraj ' , imeNajdaljsegaKraja , 'na razdalji ' , najdaljsaRazdalja)
