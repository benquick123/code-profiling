...
for ime, x, y in kraji:
    if ime == kraj:
        ...
        for ime, x, y in kraji:
            ...
            if razdalja < domet and razdalja > ndljerazdalja:
                ndlje = ime
                ndljerazdalja = razdalja
print("Iz kraja", kraj, "lahko zalijemo kraj", ndlje, "na razdalji", ndljerazdalja,)
