...
for ime, x, y in kraji:
    razdalja = sqrt((kx - x) ** 2 + (ky - y) ** 2)
    if razdalja >= najdlje and razdalja <= domet:
        najdlje = razdalja
        najdlje_ime = ime

print("Ljubljana je na koordinatah", x, y )
print("Iz kraja Ljubljana lahko zalijemo kraj", najdlje_ime, "na razdalji", najdlje)
