...
class Minobot:
    ...
    def naprej(self,d):
        if self.orient == "desno":
            self.koord = self.koord[0]+d,self.koord[1]
        elif self.orient == "levo":
            self.koord = self.koord[0]-d, self.koord[1]
        elif self.orient == "gor":
            self.koord = self.koord[0],self.koord[1]+d
        elif self.orient == "dol":
            self.koord = self.koord[0],self.koord[1]-d
