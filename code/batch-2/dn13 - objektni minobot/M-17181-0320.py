...
class Minobot:
    ...
    def razveljavi(self):
        if len(self.narejeno) != 0:
            if self.narejeno[-1][0] == 'naprej':
                self.naprej(-(self.narejeno[-1][1]))
            elif self.narejeno[-1][0] == 'levo':
                self.desno()
            elif self.narejeno[-1][0] == 'desno':
                self.levo()
            nnarejeno = self.narejeno[:-2]
            self.narejeno = nnarejeno
