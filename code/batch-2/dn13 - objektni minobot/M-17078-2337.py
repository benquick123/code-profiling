...
#smer: 0 - gor, 1 - desno, 2 - dol, 3 - levo
...
class Minobot:
    ...
    def naprej(self, d):
        if self.smer == 0:
            ...
            self.x -= d
        self.prej.append("naprej {d}".format(d=d))
    ...
    def levo(self):
        self.smer = (self.smer + 3) % 4
        self.prej.append("levo")
    ...
    def razveljavi(self):
        ...
        if ukaz == "desno":
            ...
            self.nazaj(int(ukaz.split()[1]))
        self.prej = self.prej[:-1]
