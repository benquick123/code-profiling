...
kraji = [
    ('Brežice', 68.66, 7.04), ('Lenart', 85.20, 78.75), ('Rateèe', -65.04, 70.04),
    ...
    ('Brtonigla', -71.00, -47.25), ('Kanal', -71.00, 26.25), ('Èrnomelj', 39.05, -27.93),
    ('Trbovlje', 29.61, 35.07), ('Beltinci', 114.81, 80.54), ('Domžale', -2.34, 31.50),
    ('Hodoš', 120.70, 105.00), ('Škofja Loka', -23.64, 35.07), ('Velike Lašèe', 0.00, 0.00),
    ('Velenje', 33.16, 54.29), ('Šoštanj', 29.61, 57.75), ('Laško', 42.60, 33.29),
    ('Postojna', -29.54, -5.25), ('Ilirska Bistrica', -27.19, -27.93),
    ('Radenci', 100.61, 84.00), ('Èrna', 15.41, 66.57), ('Radeèe', 39.05, 24.57),
    ...
    ('Škofije', -59.14, -27.93), ('Èepovan', -60.35, 22.78), ('Murska Sobota', 108.91, 87.57),
    ...
    ('Koèevje', 16.61, -21.00), ('Soèa', -69.79, 52.50), ('Ajdovšèina', -53.25, 5.25),
    ('Bohinjska Bistrica', -48.49, 47.25), ('Tržiè', -22.44, 56.07), ('Piran', -75.69, -31.50),
    ...
    ('Most na Soèi', -63.90, 33.29), ('Brestanica', 60.35, 15.75),
...
class TestKraji(unittest.TestCase):
    ...
    def test_1_koordinate(self):
        ...
        self.assertEqual(koordinate("Rateèe", kraji), (-65.04, 70.04))
    ...
    def test_1_range_len(self):
        class NoGetItem(list):
            def __getitem__(*x):
                raise IndexError("Nauèi se (pravilno) uporabljati zanko for!")
    ...
    def test_3_razdalja_krajev(self):
        ...
        self.assertEqual(razdalja("Brežice", "Rateèe", kraji), 7)
        self.assertAlmostEqual(razdalja("Lenart", "Rateèe", kraji), sqrt(32))
    ...
    def test_5_najbolj_oddaljeni(self):
        ...
        self.assertEqual(najbolj_oddaljeni("Lenart", ["Brežice", "Rateèe"], kraji), "Rateèe")
