...
for kraj2, x2, y2 in kraji:
    ...
    if(razdalja_med_krajema < domet and razdalja_med_krajema > najbolj_oddaljen_kraj):
        kraj3 = kraj2
        najbolj_oddaljen_kraj = razdalja_med_krajema

print(kraj, " je na koordinatah ", x1, y1)
print("Iz kraja", kraj, "lahko zalijemo kraj ", kraj3,  "na razdalji ", najbolj_oddaljen_kraj)
