...
#for list in kraji:
#    razdalja = math.sqrt(math.pow((list[1]-0),2)+math.pow((list[2]-0),2))
#    print(list[0],"  ",razdalja)
...
for list in kraji:
    razdalja = math.sqrt(math.pow((list[1] - mesto[1]), 2) + math.pow((list[2] - mesto[2]), 2))
...
print(mesto[0] ," je na koordinatah ", mesto[1], " ", mesto[2])
print("Iz kraja ", kraj, " lahko zalijemo kraj", a[0], "na razdalji ", a[1])
...
for list in kraji:
    razdalja1 = math.sqrt(math.pow((list[1] - mesto1[1]), 2) + math.pow((list[2] - mesto1[2]), 2))
    razdalja2 = math.sqrt(math.pow((list[1] - mesto2[1]), 2) + math.pow((list[2] - mesto2[2]), 2))
