...
maxrazdalja=0
maxkraj=""
for kraj_seznam,koordinata1,koordinata2 in kraji:
    if kraj_seznam == kraj:
        k1_kraja=koordinata1
        k2_kraja=koordinata2
        print(kraj_seznam," je na koordinatah ",k1_kraja," ",k2_kraja)

        for kraj_seznam, koordinata1, koordinata2 in kraji:
            razdalja_od_izhodisca = ((koordinata1 - k1_kraja) ** 2 + (koordinata2 - k2_kraja) ** 2) ** (1 / 2)
            if domet > razdalja_od_izhodisca > maxrazdalja:
                maxrazdalja = razdalja_od_izhodisca
                maxkraj = kraj_seznam

        print("Iz kraja ", kraj, " lahko zadanemo kraj ", maxkraj, " na razdaliji", maxrazdalja)
        break
else:
    print("Kraja ni v seznamu")
...
k1_kraja1 = k2_kraja1 = 0
k1_kraja2 = k2_kraja2 = 0
najdenikraji=0
for kraj_seznam,koordinata1,koordinata2 in kraji:
    if kraj_seznam == kraj1:
        k1_kraja1=koordinata1
        k2_kraja1=koordinata2
        # print(kraj_seznam," je na koordinatah ",k1_kraja1," ",k2_kraja1)
        najdenikraji +=1
    if kraj_seznam == kraj2:
        k1_kraja2 = koordinata1
        k2_kraja2 = koordinata2
        # print(kraj_seznam, " je na koordinatah ", k1_kraja2, " ", k2_kraja2)
        najdenikraji += 1
    if najdenikraji ==2:
        for kraj_seznam, koordinata1, koordinata2 in kraji:
            razdalja_od_izhodisca_kraj1 = ((koordinata1 - k1_kraja1) ** 2 + (koordinata2 - k2_kraja1) ** 2) ** (1 / 2)
            razdalja_od_izhodisca_kraj2 = ((koordinata1 - k1_kraja2) ** 2 + (koordinata2 - k2_kraja2) ** 2) ** (1 / 2)
            if domet > razdalja_od_izhodisca_kraj1 and domet > razdalja_od_izhodisca_kraj2:
                print(kraj_seznam)
        break
else:
    print("Napaka pri vnosu krajev")
