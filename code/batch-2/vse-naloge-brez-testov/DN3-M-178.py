...
for mesto, koordinata_x, koordinata_y  in kraji:
    if mesto == kraj:
        print(mesto, "je na koordinatah", koordinata_x, koordinata_y)
        ...
        print("Iz kraja", mesto, "lahko zalijemo kraj", zalito_mesto ,"na razdalji", najvecje_zalito_mesto, "\n")
...
for mesto_1, koordinata_x_1, koordinata_y_1  in kraji:
    for mesto_2, koordinata_x_2, koordinata_y_2 in kraji:
        ...
        if mesto_1 == kraj1 and mesto_2 == kraj2:

            for mesto_za_zalit, koordinata_x_za_zalit, koordinata_y_za_zalit in kraji:
                razdalja_1 = sqrt(pow((koordinata_x_za_zalit - koordinata_x_1), 2) + pow((koordinata_y_za_zalit - koordinata_y_1), 2))
                razdalja_2 = sqrt(pow((koordinata_x_za_zalit - koordinata_x_2), 2) + pow((koordinata_y_za_zalit - koordinata_y_2), 2))

                if razdalja_1 < domet and razdalja_2 < domet:
                    print(mesto_za_zalit)
