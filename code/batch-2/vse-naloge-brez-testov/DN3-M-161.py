...
for ime,x,y in kraji:
    if ime == kraj:
        x0 = x
        y0 = y
        print(kraj + " je na koordinatah " + str(x) + " " + str(y))
najvecja_razdalja = 0
naj_kraj = ""
for ime, x, y in kraji:
    ...
    if razdalja > najvecja_razdalja and razdalja <= domet:
        ...
        naj_kraj = ime
print("Iz kraja " + kraj + " lahko zalijemo kraj " + naj_kraj + " na razdalji " + str(najvecja_razdalja))
...
for i,xx,yy in kraji:
    ...
    if i == kraj2:
        ...
        k2y = yy
for ime, x, y in kraji:
    razdalja1 = sqrt((k1x - x) ** 2 + (k1y - y) ** 2)
    razdalja2 = sqrt((k2x - x) ** 2 + (k2y - y) ** 2)
