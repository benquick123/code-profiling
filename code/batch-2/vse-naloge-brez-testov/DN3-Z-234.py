...
domet = 30
ljubljana = ('Ljubljana', -8.24, 22.78)

najdalji=0
najdaljigrad=''
for ime, x, y in kraji:
    razdalja=(sqrt((ljubljana[1] - x) ** 2) + (ljubljana[2] - y) ** 2)
    if (razdalja>=najdalji and razdalja<=domet):
        najdalji=razdalja
        najdaljigrad=ime
print('iz kraja Ljubljana lahko zalijemo kraj', najdaljigrad, 'na razdalji', najdalji)