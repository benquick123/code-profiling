...
naj_razdalja = 0
naj_cilj = ""
for cilj,x2,y2 in kraji:
    razdalja = sqrt((x2 - x1)**2 + (y2 - y1)**2)
    if naj_razdalja < razdalja and razdalja < domet:
        naj_razdalja = razdalja
        naj_cilj = cilj
print("Iz kraja", kraj,"lahko zalijemo kraj" ,naj_cilj, "na razdalji", naj_razdalja, "\n")
...
print(kraj1, "in" ,kraj2, "lahko družno zalivata naslednje kraje:")
