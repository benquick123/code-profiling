...
for ime, k_1, k_2 in kraji:

    if ime == kraj:
        print(ime, "je na koordinatah", k_1, k_2)
        k1 = k_1
        k2 = k_2

        for ime, k_1, k_2 in kraji:
            razdalja = sqrt(((k_1 - k1)**2) + ((k_2 - k2)**2))

            if razdalja < domet and najbolj_oddaljen < razdalja:
    ...
    if ime == kraj1:
        ...
        for ime, k_1, k_2 in kraji:
            if ime == kraj2:
                ...
                k4 = k_2
                for ime, k_1, k_2 in kraji:
                    razdalja1 = sqrt(((k_1 - k1)**2) + ((k_2 - k2)**2))
                    razdalja2 = sqrt(((k_1 - k3) ** 2) + ((k_2 - k4) ** 2))
