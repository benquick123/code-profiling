...
for ime, x, y in kraji:
    radius = sqrt((x2 - x) ** 2 + (y2 - y) ** 2)
    if radius <= domet:
        if max_radius < radius:
            max_radius = radius
            poplavljenec = ime

print("Iz kraja", kraj, "lahko zalijemo kraj", poplavljenec, "na razdalji", max_radius)
print("DODATNA NALOGA:")

kraj1 = str(input("Vpiši kraj: "))
kraj2 = str(input("Vpiši kraj: "))
domet = float(input("Vpiši domet: "))
x1 = 1
y1 = 1
x2 = 1
