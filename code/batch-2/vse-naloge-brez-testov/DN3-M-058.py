...
for ime, x, y in kraji:
    ...
    if razdalja < domet:
        if razdalja > naj_kraj_razdalja:
            naj_kraj = ime
            naj_kraj_razdalja = razdalja
print("Iz kraja", kraj, "lahko zalijemo kraj", naj_kraj, "na razdalji", naj_kraj_razdalja)
...
print(" ")
print(kraj1, "je na koordinatah", x_kraj1, y_kraj1)
print(kraj2, "je na koordinatah", x_kraj2, y_kraj2)
print("Skupaj lahko zalijeta naslednje kraje:")

for ime, x, y in kraji:
    razdalja1 = sqrt((x - x_kraj1) ** 2 + (y - y_kraj1) ** 2)
    razdalja2 = sqrt((x - x_kraj2) ** 2 + (y - y_kraj2) ** 2)
