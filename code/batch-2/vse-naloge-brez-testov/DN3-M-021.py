...
if vsebuje == 1:
    ...
    for ime,kor1,kor2 in kraji:
        ...
        if maxraz < raz and raz <= domet:
            maxraz=raz
            maxime=ime
    print(kraj, " je na koordinatah ", kord1, " ", kord2)
    print("Iz kraja ", kraj, " lahko zalijemo kraj", maxime, " na razdalji ", maxraz)
else:
    print("Vpisali ste napačno ime kraja")
