...
for kraj_2, x2, y2 in kraji:
    if kraj_2==kraj:
        print(kraj, "je na koordinatah", x2,y2)
        break
...
print("Iz kraja", kraj, "lahko zalijemo kraj", najime, "na razdalji", najraz)
...
for kraj_a, xx2, yy2 in kraji:
    if kraj_a==kraj1:
        break

for kraj_b, xxx2, yyy2 in kraji:
    if kraj_b == kraj2:
        break


for kraj_aa, xx1, yy1 in kraji:
    d1=sqrt((xx2-xx1)**2+(yy2-yy1)**2)
    if domet>d1:
        najime1=kraj_aa
        for kraj_bb, xxx1,yyy1 in kraji:
            d2 = sqrt((xxx2 - xxx1) ** 2 + (yyy2 - yyy1) ** 2)
            if domet>d2:
                najime2=kraj_bb
                if najime2==najime1:
                    print(najime1)
