...
najbolj_oddaljen = ""
največja_oddaljenost = 0

for ime, x, y in kraji:
    oddaljenost = sqrt(((x - koordinata1)*(x - koordinata1)) + ((y - koordinata2)*(y - koordinata2)))
    if oddaljenost <= domet:
        if oddaljenost > največja_oddaljenost:
            najbolj_oddaljen = ime
            največja_oddaljenost = oddaljenost

print ("Iz kraja", kraj, "lahko zalijemo kraj", najbolj_oddaljen, "na razdalji", največja_oddaljenost)
