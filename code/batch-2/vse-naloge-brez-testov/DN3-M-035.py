...
kraj = input("Vpiši kraj s katerega želiš ustreliti: ")
domet = input("Domet vodnega topa: ")
...
print(str(kraj) + " je na koordinatih " + str(x1) + " " + str(y1))
print("Iz kraja " + str(kraj) + " lahko zalijemo kraj " + str(ciljni_kraj) + " na razdalji " + str(Najdaljsa_mozna_razdalja))