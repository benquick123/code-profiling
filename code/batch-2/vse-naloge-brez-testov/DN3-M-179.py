...
for (imeKraja, koordinataX, koordinataY) in kraji:
    if imeKraja == kraj:
        print(imeKraja, "je na koordinatah", koordinataX, koordinataY)
        koordinataX1 = koordinataX
        koordinataY1 = koordinataY

for (imeKraja, koordinataX, koordinataY) in kraji:
    x = koordinataX - koordinataX1
    y = koordinataY - koordinataY1
    razdalja = sqrt(x**2 + y**2)
    if razdalja > maxRazdalja and razdalja < domet:
...
for (imeKraja, koordinataX, koordinataY) in kraji:
    ...
    y = koordinataY - koordinataY1
    razdalja = sqrt(x**2 + y**2)
    if razdalja < domet and imeKraja in krajiDomet1 and imeKraja != kraj1 and imeKraja != kraj2:
        print(imeKraja)
        i += 1

if i == 0:
    print ("Ni bilo skupnih krajev.")
