...
for ime, x, y in kraji:
    if ime == kraj:
        ...
        for ime, x, y in kraji:
            ...
            if domet > razdalja > najvecja_razdalja:
                najvecja_razdalja = razdalja
                maxKraj = ime
        print("Iz kraja", kraj, "lahko zalijemo kraj", maxKraj, "na razdalji", najvecja_razdalja)

# Dodatna naloga (kdor želi)

kraj1 = str(input("Vnesi kraj1:"))
kraj2 = str(input("Vnesi kraj2:"))
domet = int(input("Vnesi domet:"))
