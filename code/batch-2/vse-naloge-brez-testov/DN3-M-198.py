...
domet = input("Vpiši domet:(celo število)")
domet = int(domet)
...
for i in kraji:
    if i[0] == kraj:
        kordinati[0] = i[1]
        kordinati[1] = i[2]
print("Ljubljana je na kordinatih", kordinati[0], kordinati[1])


maxDomet = 0
maxIme = ""
for i in kraji:
    if sqrt( (i[1] - kordinati[0])**2 + (i[2] - kordinati[1])**2 ) <= domet:
        if maxDomet < sqrt( (i[1] - kordinati[0])**2 + (i[2] - kordinati[1])**2 ):
            maxDomet = sqrt( (i[1] - kordinati[0])**2 + (i[2] - kordinati[1])**2 )
            maxIme = i[0]
print("Iz kraja ",kraj," lahko zalijemo kraj ",maxIme," na razdalji", maxDomet);
...
print("---------------------------------------------------------")
kraj1 = "Ljubljana"#input("Vpiši kraj1: ")
kraj2 = "Bled"#input("Vpiši kraj2: ")
domet = 30#input("Vpiši domet: (celo število)")
korKraj1 = [0,0]
korKraj2 = [0,0]
...
for i in kraji:
    if sqrt( (i[1] - korKraj1[0])**2 + (i[2] - korKraj1[1])**2 ) <= domet:
        if sqrt( (i[1] - korKraj2[0])**2 + (i[2] - korKraj2[1])**2 ) <= domet:
            print(i[0])
