...
for x in kraji:
    ...
    if kraj1 == str(ime):
        ...
        c = float (widght)
        break
print(a,'' is on'',b,'','', c,'' and has a domet of '', domet)
blize=0
for x2 in kraji:
    ime2, height2, widght2 = x2
    d=sqrt(pow((height2-b),2)+pow((widght2-c),2))
    if d <= domet and d >= blize:
        ...
        b1 = height2
        c1 = widght2
        print (''iz kraja'',a,'' lako zalijemo kraj'', a1, '' na razdaljini '', dalec)
