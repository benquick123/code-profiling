...
# izračuna razdaljo od izhodišča do kraja
# izpise najbolj oddaljen kraj v dometu
for lokacija, x, y in kraji:
    kX = izX - x
    kY = izY - y
    razdalja = sqrt(kX**2 + kY**2)
    if razdalja < domet and razdalja > max:
        cilj = lokacija
        ciljRazdalja = razdalja
        max = razdalja

print("Iz kraja ", kraj, "lahko zadanemo kraj", cilj, "na razdalji", ciljRazdalja)
