...
def sosedov(x, y, mine):
    ...
    sosedi = 0
    for x1, y1 in mine:
        if (x1 - 1, y1 - 1) == (x, y) or (x1, y1 - 1) == (x, y) or (x1 + 1, y1 - 1) == (x, y) or (x1 + 1, y1) == (x, y) or (x1 + 1, y1 + 1) == (x, y) or (x1, y1 + 1) == (x, y) or (x1 - 1, y1 - 1) == (x, y) or (x1 - 1, y1) == ( x, y) or (x1 - 1, y1 + 1) == (x, y):
            sosedi += 1
