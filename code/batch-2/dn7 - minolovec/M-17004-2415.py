...
def najvec_sosedov(mine, s, v):
    ...
    polje = (0, 0)
    koordinate = []
    koordinate.extend(vsa_polja(s, v))
    for a, b in koordinate:
        naj_sosedov = sosedov(a, b, mine)
        if naj_sosedov > naj_mine:
            polje = (a, b)
            naj_mine = naj_sosedov
    return polje
...
def po_sosedih(mine, s, v):
    ...
    for kluc in range(0, 9):
        slovar[kluc] = set()
    for a, b in koordinate:
        stevilo_min = sosedov(a, b, mine)
        polje = slovar[stevilo_min]
        polje.add((a, b))
        slovar[stevilo_min] = polje
